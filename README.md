...
## Files
- `CC_Database.sql` – Database schema and transformations  
- `*.csv` – Raw datasets  
- `Credit_Credit_Report.pbix` – Power BI dashboard  
- `*.pdf` – Exported analysis reports  

## Outcome
Converted raw credit card data into actionable insights through SQL queries and Power BI visualizations.
